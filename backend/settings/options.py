    ...
    SettingGroup(
        ...
        options=[
            ...
            SettingOption(
                ...
                option_type="text",
                description="API Key required to use Sadie Source. Generated automatically via Session Cookie.",
                default="",
                metadata={"placeholder": "Auto-gerado pela Sessão (Leia o aviso abaixo)"},
            ),
            SettingOption(
                key="hubcapSessionCookie",
                label="Hubcap Session Cookie (Auto-Renovação)",
                option_type="text",
                description="Seu Cookie 'session' (eyJh...). Necessário para gerar chaves automaticamente p/ Sadie.",
                default="",
                metadata={"placeholder": "Cole seu Session Cookie base64 aqui..."},
            ),
        ],
    ),
]
